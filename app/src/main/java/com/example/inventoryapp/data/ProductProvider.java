...
public class ProductProvider extends ContentProvider {
    ...
    static {
        URI_MATCHER.addURI(ProductContract.CONTENT_AUTHORITY, ProductContract.PATH_PRODUCT, PRODUCT);
        URI_MATCHER.addURI(ProductContract.CONTENT_AUTHORITY, ProductContract.PATH_PRODUCT + "/#", PRODUCT_ID);
    }
    ...
    private Uri insertProduct(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        if (productImage == null) {
            throw new IllegalArgumentException("Product requires a product image");
        }

        Integer productGrade = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_GRADE);
        if (productGrade == null) {
            throw new IllegalArgumentException("Product requires valid product grade");
        }
        ...
        Integer supplierPhone = values.getAsInteger(ProductEntry.COLUMN_SUPPLIER_PHONE);
    ...
    public int updateProduct(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        if (values.containsKey(ProductContract.ProductEntry.COLUMN_PRODUCT_GRADE)) {
            Integer productGrade = values.getAsInteger(ProductContract.ProductEntry.COLUMN_PRODUCT_GRADE);
            if (productGrade == null) {
                throw new IllegalArgumentException("Product requires valid product grade");
            }
        }
        ...
        if (values.containsKey(ProductEntry.COLUMN_SUPPLIER_PHONE)) {
            Integer supplierPhone = values.getAsInteger(ProductContract.ProductEntry.COLUMN_SUPPLIER_PHONE);
            if (supplierPhone == null) {
                throw new IllegalArgumentException("Product requires valid supplier phone");
            }
        }
